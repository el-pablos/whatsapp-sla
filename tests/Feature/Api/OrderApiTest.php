...
describe('Order API', function () {
    ...
    describe('GET /api/orders', function () {
        ...
        it('searches orders by customer phone', function () {
            ...
            $response = $this->getJson('/api/orders?search=1234');
        ...
        it('filters by date range', function () {
            ...
            $response = $this->getJson("/api/orders?date_from={$dateFrom}&date_to={$dateTo}");
        ...
        it('respects per_page parameter', function () {
            ...
            $response = $this->getJson('/api/orders?per_page=5');
    ...
    describe('PATCH /api/orders/{id}/status', function () {
        ...
        it('returns 404 for non-existent order', function () {
            $response = $this->patchJson('/api/orders/999/status', [
                'status' => Order::STATUS_CONFIRMED,
            ]);
