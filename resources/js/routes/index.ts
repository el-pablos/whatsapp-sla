 ...
 * @see app/Http/Controllers/Auth/LoginController.php:40
 * @route '/logout'
 */
...
/**
* @see \App\Http\Controllers\SettingsController::settings
 * @see app/Http/Controllers/SettingsController.php:11
 * @route '/settings'
 */
